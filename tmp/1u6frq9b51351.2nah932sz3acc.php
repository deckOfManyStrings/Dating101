                ...
                <div class="row h-100">
                        ...
                        <div class="form-group">
                            ...
                            <div class="container" id="genderGroup">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inputGender" id="male"
                                           value="Male" <?= ($genderMale) ?>>
                                    <label class="form-check-label" for="male">Male</label>
                                </div>
                                <div class="form-check form-check-inline" id="femaleGroup">
                                    <input class="form-check-input" type="radio" name="inputGender" id="female"
                                           value="Female" <?= ($genderFemale) ?>>
                    ...
                    <div class="col-md-4" id="column2">
                        <div class="alert alert-secondary text-center" role="alert">
                            <strong>Note: </strong>All information entered is protected by our <a href="">privacy
                                policy</a>. Profile information can only be viewed by others with your permission.
                        </div>
